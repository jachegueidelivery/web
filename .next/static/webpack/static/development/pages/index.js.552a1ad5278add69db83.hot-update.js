...
var TotalPedidos = function TotalPedidos(props) {
  ...
  if (countPedidosLocal <= 0) {
    ...
    if (!carregado) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_5__["default"], {
        disableShrink: true,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 25
  ...
  /*
    return (
      <Badge badgeContent={!props.count ? 0 : props.count} color="primary">
...
//# sourceMappingURL=index.js.552a1ad5278add69db83.hot-update.js.map